...
/*******************************************************************************
* Function Name  : i2c6_scl0
* Description    : scl0
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
static int i2c6_scl0(void)
{
...
/*******************************************************************************
* Function Name  : i2c6_scl1
* Description    : scl1
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
static int i2c6_scl1(void)
{
...
/*******************************************************************************
* Function Name  : i2c6_scl_read
* Description    : scl_read
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
static int i2c6_scl_read(void)
{
    return HAL_GPIO_ReadPin(SCL_GPIO, SCL_GPIO_PIN);
}

/*******************************************************************************
* Function Name  : i2c6_sda0
* Description    : sda0
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
static int i2c6_sda0(void)
{
...
/*******************************************************************************
* Function Name  : i2c6_sda1
* Description    : sda1
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
static int i2c6_sda1(void)
{
...
/*******************************************************************************
* Function Name  : i2c6_sda_read
* Description    : sda_read
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
static int i2c6_sda_read(void)
{
    return HAL_GPIO_ReadPin(SDA_GPIO, SDA_GPIO_PIN);
}

/*******************************************************************************
* Function Name  : i2c6_delay
* Description    : DELAY
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
static void i2c6_delay(void)
{
    bsp_delay_us(20);
}

/*******************************************************************************
* Function Name  : i2c6_mutex_take
* Description    : mutex_take
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
static int i2c6_mutex_take(void)
{
    return xSemaphoreTake(s_mutex, portMAX_DELAY);
}

/*******************************************************************************
* Function Name  : i2c6_mutex_give
* Description    : mutex_give
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
static int i2c6_mutex_give(void)
{
    return xSemaphoreGive(s_mutex);
}

/*******************************************************************************
* Function Name  : i2c6_init
* Description    : init
* Input          : None
* Output         : None
* Return         : 0正常，非0异常
