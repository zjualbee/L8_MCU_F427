...
void Init_Ads7830(void)
{
    ...
    Ads8730_Init(&Ntc_1_8,DEVICE_ID_NTC1,I2c_Recv,I2c_Transmit,osDelay); //色轮温度3x
    #ifdef NTC2_EN
    Ads8730_Init(&Ntc_9_16,DEVICE_ID_NTC2,I2c_Recv,I2c_Transmit,osDelay); //光源温度4x
    #endif
    #ifdef NTC3_EN
    Ads8730_Init(&Ntc_17_24,DEVICE_ID_NTC3,I2c_Recv,I2c_Transmit,osDelay); //环境温度1x
    #endif
}
