...
// g_queue_dlp4422 = xQueueCreate(1,120);
	...
	uint8_t dlp_flip[20] = {0x5A,0xA5,0x00,0x0D,0x00,0x00,0x08,0x01,0x0C,0x63,0x00,0x01,0x95};
	uint8_t dlp_blank[20]={0x5a,0xa5,0x00,0x0c,0,0,0x08,0x01,0x14,0x04,0x08,0xE2};
